...
class MCSimulation:
    ...
    def calc_cumulative_return(self):
        ...
        messages = [
            "There's a horrible message coming right up. Ready?",
            "\n",
            "...Told ya",
    ...
    def plot_simulation(self):
        ...
        # Hack interrupt!! I use matplotlib, because yes.
        ...
        filename = "./resources/" + "simulation.png"

        plot_mean = self.simulated_return.plot(
            legend=None, title=plot_title, figsize=(20, 20), alpha=0.1
        )
        plot_mean = self.simulated_return.mean(axis=1).plot(
            legend=None, title=plot_title, figsize=(20, 20), linewidth=5
        )
